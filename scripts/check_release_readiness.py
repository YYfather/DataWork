...
def main() -> int:
    ...
    required = [
        ...
        "docs/QUALITY_AUDIT_RECORDS.md",
        "docs/DEVELOPMENT_RECORDS.md",
        "golden_datasets/manifest.json",
        "scripts/run_golden_validation.py",
        "scripts/smoke_sidecar.py",
        "scripts/package_portable.py",
        "scripts/package_platform_releases.py",
        "desktop/package-lock.json",
        "scripts/package_source.py",
        "deploy/macos/安装 DataWork.command",
        "deploy/macos/启动 DataWork.command",
        "deploy/linux-server/bt_start.py",
        "deploy/linux-server/requirements.txt",
        "deploy/linux-server/宝塔面板部署说明.txt",
    ]
